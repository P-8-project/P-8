...
void handlerargstest()
{
    ...
    std::string configFile = "examples/config/p-8.conf";
    ...
    TEST_ASSERT_EQ(extArgs[0], QString("examples/config/p-8.conf"));
    ...
    TEST_ASSERT_EQ(args.configFile, QString("examples/config/p-8.conf"));
    ...
    // Verify the arguments
    TEST_ASSERT_EQ(extArgs_empty[0], QString("examples/config/p-8.conf"));
    ...
    TEST_ASSERT_EQ(args_empty.configFile, QString("examples/config/p-8.conf"));
