...
use clap::{Parser, arg};
use p-8::core::{call_c_main, version};
use p-8::core::config::get_config_file;
use p-8::import_cpp;
use std::env;
...
mod tests {
    ...
    fn test_cli_args() {
        ...
        let args = CliArgs {
            ...
            log_file: Some("p-8.log".to_string()),
            log_level: 3,
        ...
        assert_eq!(verified_args.log_file, Some("p-8.log".to_string()));
        ...
        assert_eq!(osstring_vec[1], OsString::from("p-8.log"));
