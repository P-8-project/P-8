...
public class ViableEitherRuleImpl extends ASTWrapperPsiElement implements ViableEitherRule {

  public ViableEitherRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ViableVisitor visitor) {
    visitor.visitEitherRule(this);
  }
