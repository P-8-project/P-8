...
public class ViableVariableRuleImpl extends ASTWrapperPsiElement implements ViableVariableRule {

  public ViableVariableRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ViableVisitor visitor) {
    visitor.visitVariableRule(this);
  }
