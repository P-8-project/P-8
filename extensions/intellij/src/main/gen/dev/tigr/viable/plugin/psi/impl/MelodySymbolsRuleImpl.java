...
public class ViableSymbolsRuleImpl extends ASTWrapperPsiElement implements ViableSymbolsRule {

  public ViableSymbolsRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ViableVisitor visitor) {
    visitor.visitSymbolsRule(this);
  }
