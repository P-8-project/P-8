...
public class ViableStringRuleImpl extends ASTWrapperPsiElement implements ViableStringRule {

  public ViableStringRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ViableVisitor visitor) {
    visitor.visitStringRule(this);
  }
