...
public class ViableToRuleImpl extends ASTWrapperPsiElement implements ViableToRule {

  public ViableToRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ViableVisitor visitor) {
    visitor.visitToRule(this);
  }
