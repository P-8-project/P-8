...
public class ViableOverRuleImpl extends ASTWrapperPsiElement implements ViableOverRule {

  public ViableOverRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ViableVisitor visitor) {
    visitor.visitOverRule(this);
  }
