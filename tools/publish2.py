# this program uses p-8's SUB socket to publish
...
# need to publish from a short-running program in real life, use p-8's
# PULL socket, or create a long-running broker that uses PUB to p-8 and
