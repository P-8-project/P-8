...
cp -a .gitignore CHANGELOG.md configure COPYING corelib doc examples handler m2adapter Makefile proxy p-8 p-8.pro p-8.qc README.md runner tools build/p-8-$VERSION
