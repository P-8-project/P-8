...
class P-8ProxyService(SingleProcessService):
	def __init__(self, binpath, configpath, logdir):
		super(P-8ProxyService, self).__init__(logdir)
		self.binpath = binpath
		self.configpath = configpath
...
class P-8HandlerService(SingleProcessService):
	def __init__(self, binpath, configpath, logdir):
		super(P-8HandlerService, self).__init__(logdir)
		self.binpath = binpath
		self.configpath = configpath
