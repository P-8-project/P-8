...
def write_m2adapter_config(configpath, rundir, ports):
	...
	for port in ports:
		i = dict()
		i["send_spec"] = "ipc:///tmp/p-8-m2-out-" + str(port)
		i["recv_spec"] = "ipc:///tmp/p-8-m2-in-" + str(port)
		i["send_ident"] = "p-8-m2-" + str(port)
		i["control_spec"] = "ipc:///tmp/p-8-m2-control-" + str(port)
		instances.append(i)
